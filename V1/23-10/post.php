...
<div id="postmessagebuttondiv"><input id="postmessage" value='+ Post message' type="submit"></div>
...
<div id="messageposter">
	...
	<div id="postmessagebuttondiv2"><input id="postmessage" value='+ Post message' type="submit"></div>
	</div>
